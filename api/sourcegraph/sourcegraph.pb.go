...
func (*DefsListExamplesOp) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{98} }
...
func (*DefsRefreshIndexOp) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{122} }
...
func (*RepoSearchResult) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{143} }
...
func (*DefSearchResult) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{144} }
...
func (*SearchResultsList) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{145} }
...
func (*LatestDesktopVersion) Descriptor() ([]byte, []int) {
	return fileDescriptorSourcegraph, []int{146}
}
...
func (*ChannelListenOp) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{147} }
...
func (*ChannelAction) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{148} }
...
func (*ChannelSendOp) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{149} }
...
func (*ChannelSendResult) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{150} }
...
func init() {
	...
	proto.RegisterType((*BlacklistTokenSpec)(nil), "sourcegraph.BlacklistTokenSpec")
	proto.RegisterType((*BlacklistCheckSpec)(nil), "sourcegraph.BlacklistCheckSpec")
	proto.RegisterType((*BlacklistResponse)(nil), "sourcegraph.BlacklistResponse")
	proto.RegisterType((*BlacklistCheckResponse)(nil), "sourcegraph.BlacklistCheckResponse")
...
type AuthClient interface {
	...
	BlacklistToken(ctx context.Context, in *BlacklistTokenSpec, opts ...grpc.CallOption) (*BlacklistResponse, error)
	CheckBlacklist(ctx context.Context, in *BlacklistCheckSpec, opts ...grpc.CallOption) (*BlacklistCheckResponse, error)
}
...
func (c *authClient) BlacklistToken(ctx context.Context, in *BlacklistTokenSpec, opts ...grpc.CallOption) (*BlacklistResponse, error) {
	out := new(BlacklistResponse)
	err := grpc.Invoke(ctx, "/sourcegraph.Auth/BlacklistToken", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authClient) CheckBlacklist(ctx context.Context, in *BlacklistCheckSpec, opts ...grpc.CallOption) (*BlacklistCheckResponse, error) {
	out := new(BlacklistCheckResponse)
	err := grpc.Invoke(ctx, "/sourcegraph.Auth/CheckBlacklist", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServer interface {
	...
	BlacklistToken(context.Context, *BlacklistTokenSpec) (*BlacklistResponse, error)
	CheckBlacklist(context.Context, *BlacklistCheckSpec) (*BlacklistCheckResponse, error)
}
...
func _Auth_BlacklistToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error) (interface{}, error) {
	in := new(BlacklistTokenSpec)
	if err := dec(in); err != nil {
		return nil, err
	}
	out, err := srv.(AuthServer).BlacklistToken(ctx, in)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Auth_CheckBlacklist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error) (interface{}, error) {
	in := new(BlacklistCheckSpec)
	if err := dec(in); err != nil {
		return nil, err
	}
	out, err := srv.(AuthServer).CheckBlacklist(ctx, in)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var _Auth_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Auth_BlacklistToken_Handler,
		},
		{
			MethodName: "CheckBlacklist",
			Handler:    _Auth_CheckBlacklist_Handler,
		},
	},
	Streams: []grpc.StreamDesc{},
}
...
func (m *BlacklistTokenSpec) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *BlacklistTokenSpec) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *BlacklistCheckSpec) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *BlacklistCheckSpec) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *BlacklistCheckResponse) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *BlacklistCheckResponse) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if m.BlacklistedUntil != nil {
		data[i] = 0x12
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.BlacklistedUntil.Size()))
		n135, err := m.BlacklistedUntil.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n135
...
func (m *BlacklistTokenSpec) Size() (n int) {
	var l int
	_ = l
	if m.Uid != 0 {
		n += 1 + sovSourcegraph(uint64(m.Uid))
...
func (m *BlacklistCheckSpec) Size() (n int) {
	var l int
	_ = l
	if m.Uid != 0 {
		n += 1 + sovSourcegraph(uint64(m.Uid))
...
func (m *BlacklistCheckResponse) Size() (n int) {
	var l int
	_ = l
	if m.Ok {
		n += 2
...
func (m *BlacklistTokenSpec) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BlacklistTokenSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BlacklistTokenSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *BlacklistCheckSpec) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BlacklistCheckSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BlacklistCheckSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *BlacklistCheckResponse) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BlacklistCheckResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BlacklistCheckResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BlacklistedUntil", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.BlacklistedUntil == nil {
				m.BlacklistedUntil = &pbtypes.Timestamp{}
			}
			if err := m.BlacklistedUntil.Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorSourcegraph = []byte{
	...
	,
