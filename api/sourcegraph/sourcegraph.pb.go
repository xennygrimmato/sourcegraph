...
type RepoResolution_Repo struct {
	Repo int32 `protobuf:"varint,1,opt,name=Repo,proto3,oneof"`
}
...
func (m *RepoResolution) GetRepo() int32 {
...
func _RepoResolution_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *RepoResolution_Repo:
		...
		_ = b.EncodeVarint(uint64(x.Repo))
...
func _RepoResolution_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 1: // result.Repo
		...
		m.Result = &RepoResolution_Repo{int32(x)}
		return true, err
...
func _RepoResolution_OneofSizer(msg proto.Message) (n int) {
	...
	case *RepoResolution_Repo:
		...
		n += proto.SizeVarint(uint64(x.Repo))
	case *RepoResolution_RemoteRepo:
...
type ReposClient interface {
	...
	// Resolve accepts a slash-separated path, such as "my/repo" or
	// "github.com/myorg/myrepo". If that path refers to a repo that
	// has already been created locally, it returns the repo's ID. If
	// no local repo is found, it will look it up remotely (on GitHub)
	// and return a RemoteRepo if found.
	//
	// Example use case: The app calls Resolve with
	// "github.com/my/repo" to support navigating directly to
	// "https://sourcegraph.com/github.com/my/repo" when that has not
	// been created yet. The app will transparently call Repos.Create
	// if it gets a RemoteRepo back from Repos.Resolve.
...
func (m *RemoteRepo) MarshalTo(data []byte) (int, error) {
	...
	if m.UpdatedAt != nil {
		...
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.UpdatedAt.Size()))
		n27, err := m.UpdatedAt.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n27
	...
	if m.PushedAt != nil {
		...
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.PushedAt.Size()))
		n28, err := m.PushedAt.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n28
...
func (m *Build) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.CreatedAt.Size()))
	n29, err := m.CreatedAt.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n29
	...
	if m.EndedAt != nil {
		...
		n31, err := m.EndedAt.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n31
	...
	if m.HeartbeatAt != nil {
		...
		n32, err := m.HeartbeatAt.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n32
	...
	n33, err := m.BuildConfig.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n33
...
func (m *BuildTask) MarshalTo(data []byte) (int, error) {
	...
	n36, err := m.Build.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n36
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.CreatedAt.Size()))
	n37, err := m.CreatedAt.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n37
...
func (m *BuildList) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.StreamResponse.Size()))
	n44, err := m.StreamResponse.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n44
...
func (m *BuildsUpdateTaskOp) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.Info.Size()))
	n52, err := m.Info.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n52
...
func (m *BuildsGetTaskLogOp) MarshalTo(data []byte) (int, error) {
	...
	if m.Opt != nil {
		...
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.Opt.Size()))
		n54, err := m.Opt.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n54
...
func (m *OrgsListMembersOp) MarshalTo(data []byte) (int, error) {
	...
	n57, err := m.Org.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n57
...
func (m *Person) MarshalTo(data []byte) (int, error) {
	...
	n59, err := m.PersonSpec.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n59
...
func (m *TaskUpdate) MarshalTo(data []byte) (int, error) {
	...
	if m.StartedAt != nil {
		...
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.StartedAt.Size()))
		n61, err := m.StartedAt.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n61
	...
	if m.EndedAt != nil {
		...
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.EndedAt.Size()))
		n62, err := m.EndedAt.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n62
...
func (m *User) MarshalTo(data []byte) (int, error) {
	...
	if m.RegisteredAt != nil {
		...
		n63, err := m.RegisteredAt.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n63
...
func (m *OrgsListOp) MarshalTo(data []byte) (int, error) {
	...
	n65, err := m.Member.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n65
...
func (m *AccessTokenRequest) MarshalTo(data []byte) (int, error) {
	...
	if m.AuthorizationGrant != nil {
		nn69, err := m.AuthorizationGrant.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += nn69
...
func (m *AccessTokenRequest_ResourceOwnerPassword) MarshalTo(data []byte) (int, error) {
	...
	if m.ResourceOwnerPassword != nil {
		...
		n70, err := m.ResourceOwnerPassword.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n70
...
func (m *AccessTokenRequest_GitHubAuthCode) MarshalTo(data []byte) (int, error) {
	...
	if m.GitHubAuthCode != nil {
		...
		n71, err := m.GitHubAuthCode.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n71
...
func (m *AccessTokenResponse) MarshalTo(data []byte) (int, error) {
	...
	if m.GitHubUser != nil {
		...
		n72, err := m.GitHubUser.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n72
...
func (m *Def) MarshalTo(data []byte) (int, error) {
	...
	n73, err := m.Def.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n73
	if m.DocHTML != nil {
		...
		n74, err := m.DocHTML.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n74
	...
	if m.FmtStrings != nil {
		...
		n75, err := m.FmtStrings.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n75
...
func (m *DefList) MarshalTo(data []byte) (int, error) {
	...
	n80, err := m.ListResponse.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n80
...
func (m *RefList) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.StreamResponse.Size()))
	n83, err := m.StreamResponse.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n83
...
var fileDescriptorSourcegraph = []byte{
	...
	,
}
