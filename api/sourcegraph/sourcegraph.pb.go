...
type DefListRefsOptions struct {
	...
	ListOptions `protobuf:"bytes,3,opt,name=ListOptions,embedded=ListOptions" json:""`
	// Authorship is whether to include VCS blame information about
	// who committed each ref.
	Authorship bool `protobuf:"varint,5,opt,name=Authorship,proto3" json:"Authorship,omitempty" url:",omitempty"`
}
...
type RefList struct {
	...
	// Authors contains the author for each ref, if
	// DefListRefsOptions.Authorship is true. Each item in this list
	// corresponds to the same-index item in the Refs list.
	Authors        []*RefAuthor `protobuf:"bytes,3,rep,name=Authors" json:"Authors,omitempty"`
	StreamResponse `protobuf:"bytes,2,opt,name=StreamResponse,embedded=StreamResponse" json:""`
}
...
// RefAuthor describes the author of a ref.
...
func (m *RefAuthor) Reset()                    { *m = RefAuthor{} }
func (m *RefAuthor) String() string            { return proto.CompactTextString(m) }
func (*RefAuthor) ProtoMessage()               {}
func (*RefAuthor) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{96} }
...
type DefClient struct {
	// Email is the client's email. It may be obfuscated or truncated
	// to prevent spam.
	Email string `protobuf:"bytes,1,opt,name=Email,proto3" json:"Email,omitempty"`
	// AvatarURL is the URL to the client's avatar image, if any.
	AvatarURL      string `protobuf:"bytes,2,opt,name=AvatarURL,proto3" json:"AvatarURL,omitempty"`
	AuthorshipInfo `protobuf:"bytes,3,opt,name=AuthorshipInfo,embedded=AuthorshipInfo" json:""`
	// Refs are all of the instances where the client used the def.
	Refs []*graph1.Ref `protobuf:"bytes,4,rep,name=Refs" json:"Refs,omitempty"`
}
...
func (*DefClient) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{131} }
...
func (*DefListClientsOptions) Descriptor() ([]byte, []int) {
	return fileDescriptorSourcegraph, []int{132}
}

type DefsListClientsOp struct {
	Def DefSpec `protobuf:"bytes,1,opt,name=Def" json:"Def"`
	// Repo (required) scopes the query to only clients that use the
	// def in the given repo. Global clients queries ("who calls foo()
	// anywhere in any repository globally") are not yet supported,
	// but API clients can repeatedly call Defs.ListClients with
	// multiple Repo arguments.
	Repo int32 `protobuf:"varint,2,opt,name=Repo,proto3" json:"Repo,omitempty"`
	// CommitID (required) is the commit ID corresponding to the Repo
	// param.
	CommitID string                 `protobuf:"bytes,3,opt,name=CommitID,proto3" json:"CommitID,omitempty"`
	Opt      *DefListClientsOptions `protobuf:"bytes,4,opt,name=Opt" json:"Opt,omitempty"`
}
...
func (*DefsListClientsOp) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{133} }
...
func (*DefClientList) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{134} }
...
func init() {
	...
	proto.RegisterType((*RefAuthor)(nil), "sourcegraph.RefAuthor")
	...
	proto.RegisterType((*DefClient)(nil), "sourcegraph.DefClient")
	proto.RegisterType((*DefListClientsOptions)(nil), "sourcegraph.DefListClientsOptions")
	proto.RegisterType((*DefsListClientsOp)(nil), "sourcegraph.DefsListClientsOp")
	proto.RegisterType((*DefClientList)(nil), "sourcegraph.DefClientList")
...
func (m *PendingPasswordReset) MarshalTo(data []byte) (int, error) {
	...
	if m.Token != nil {
		...
		n64, err := m.Token.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n64
...
func (m *AccessTokenRequest) MarshalTo(data []byte) (int, error) {
	...
	if m.AuthorizationGrant != nil {
		nn66, err := m.AuthorizationGrant.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += nn66
...
func (m *AccessTokenRequest_ResourceOwnerPassword) MarshalTo(data []byte) (int, error) {
	...
	if m.ResourceOwnerPassword != nil {
		...
		n67, err := m.ResourceOwnerPassword.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n67
...
func (m *AccessTokenRequest_GitHubAuthCode) MarshalTo(data []byte) (int, error) {
	...
	if m.GitHubAuthCode != nil {
		...
		n68, err := m.GitHubAuthCode.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n68
...
func (m *AccessTokenResponse) MarshalTo(data []byte) (int, error) {
	...
	if m.GitHubUser != nil {
		...
		n69, err := m.GitHubUser.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n69
...
func (m *Def) MarshalTo(data []byte) (int, error) {
	...
	n70, err := m.Def.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n70
	if m.DocHTML != nil {
		...
		n71, err := m.DocHTML.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n71
	...
	if m.FmtStrings != nil {
		...
		n72, err := m.FmtStrings.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n72
...
func (m *DefList) MarshalTo(data []byte) (int, error) {
	...
	n77, err := m.ListResponse.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n77
...
func (m *DefsListRefsOp) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.Def.Size()))
	n78, err := m.Def.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n78
...
func (m *RefList) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.StreamResponse.Size()))
	n80, err := m.StreamResponse.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n80
...
func (m *RefAuthor) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *RefAuthor) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	n81, err := m.AuthorshipInfo.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n81
...
func (m *DefClient) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.AuthorshipInfo.Size()))
	n121, err := m.AuthorshipInfo.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n121
...
func (m *RefList) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Authors = append(m.Authors, &RefAuthor{})
...
func (m *RefAuthor) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RefAuthor: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RefAuthor: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorSourcegraph = []byte{
	...
	,
}
