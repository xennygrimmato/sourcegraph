 ...
 */
module.exports.formPathForScope = formPathForScope = function(data) {
    return util.formPath(data.start, data.end);
}
...
var pathVisitor = walk.make({
    ...
    ImportDeclaration: function(node, scopeInfo, c) {
        ...
        for (var i = 0; i < node.specifiers.length; ++i) {
            if (node.specifiers[i].type == 'ImportDefaultSpecifier' || node.specifiers[i].type == 'ImportSpecifier') {
