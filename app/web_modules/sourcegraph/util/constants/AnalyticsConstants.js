...
export const INTEGRATION_SUBLIME = "Sublime";
export const INTEGRATION_EMACS = "Emacs";
export const INTEGRATION_VIM = "VIM";
export const INTEGRATION_FIREFOX = "Firefox";
export const INTEGRATION_VSCODE = "VSCode";
export const INTEGRATION_INTELLIJ = "IntelliJ";
export const INTEGRATION_ALFRED = "Alfred";
export const INTEGRATION_CHROME = "Alfred";
