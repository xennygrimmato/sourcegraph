...
func (s *users) Get(ctx context.Context, userSpec sourcegraph.UserSpec) (*sourcegraph.User, error) {
	if err := accesscontrol.VerifyUserHasReadAccess(ctx, "Users.Get", 0, ""); err != nil {
		return nil, err
	}
...
func (s *users) List(ctx context.Context, opt *sourcegraph.UsersListOptions) ([]*sourcegraph.User, error) {
	if err := accesscontrol.VerifyUserHasWriteAccess(ctx, "Users.List", 0, ""); err != nil {
		return nil, err
	}
	var args []interface{}
...
func (s *users) GetUIDByGitHubID(ctx context.Context, githubUID int) (int32, error) {
	if err := accesscontrol.VerifyUserHasReadAccess(ctx, "Users.GetUIDByGitHubID", 0, ""); err != nil {
		return 0, err
	}
