...
var langs_ = []string{"Bash", "Go", "Java", "JavaScript", "TypeScript", "PHP", "Python", "Ruby", "Objective-C", "C", "C#", "C++", "CSS"}
var langRepos_ = map[string][]string{
	...
	"Java": []string{
		...
		"github.com/futurice/android-best-practices",
		...
		"github.com/aporter/coursera-android",
